<template>
    <div class="notice">
        <h1 class="hosname">{{ detailStore.hospitalInfo.hospital?.hosname }}预约挂号须知</h1>
        ...
        <div class="info">
            ...
            <div class="text">如预约成功后患者未能按时就诊且不办理取消预约号视为爽约，同一患者在自然年内爽约规则如下：
                ...
                累计爽约6次，自6次爽约日起，180天内不允许通过114平台进行预约挂号。</div>
        </div>
    </div>
</template>
